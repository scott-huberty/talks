...
![](figures/usc-transparent.png){fig-alt="University of Southern California logo"}
![](figures/James-Desjardins.png){.profile-headshot fig-alt="James Desjardins"}
:::
...
::: {.text-panel}
- Project-specific and field-specific information
